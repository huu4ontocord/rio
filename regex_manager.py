...
def detect_ner_with_regex_and_context(sentence, src_lang,  tag_type= {'ID', 'KEY', 'EMAIL', 'USER', 'IP_ADDRESS', 'PHONE', 'LICENSE_PLATE'}, prioritize_lang_match_over_ignore=True, \
