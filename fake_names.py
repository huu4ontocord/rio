...
punjabi_firstnames_male = [
  'ਅਵਿਜੀਤ', 'ਅਭਿਸ਼ੇਕ', 'ਆਦਿੱਤਿਆ', 'ਅਗਨੀਵ', 'ਆਲੋਕ', 'ਅਮਿਤ', 'ਅਮਿਤਾਭ', 'ਅਨੰਨਿਆ', 'ਅਨਿਰੁੱਧ', 'ਅੰਕੁਰ', 'ਅਨਿਰੁੱਧ', 'ਅਰਿਜੀਤ', 'ਅਰਿੰਦਮ', 'ਅਰਿੰਡਮ', 'ਅਰਿਜੀਤ', 'ਅਰਿਕ', 'ਅਰਿਕ', 'ਅਭੀਕ', 'ਅਭਿਸ਼ੇਕ', 'ਅਯਾਨ', 'ਭਾਸਕਰ', 'ਵਿਕਾਸ', 
...
gujurati_firstnames_female = [
  'અદ્રીજા', 'અનન્યા', 'અનિંદિતા', 'અંકિતા', 'અનુરાધા', 'અનુરાધા', 'અનુષ્કા', 'અન્વેષા', 'અપર્ણા', 'અરિજિત', 'અરુનાથથી', 'અસ્મિતા', 'બિપાશા', 'વિશાખા', 'ચૈત્ય', 'ચંદ્રી', 'દેબંઝણા', 'દેબંજીત', 'ઈન્દ્રાણી', 'અરિજિત', 'અરિજીત', 'અરિજિત', 'અરિજા', 'અરિજિત', 'અરિજીત', 'અરિજિત', 'અરિજીત', 'અરિજિત', 'અરિજા',
  'પલ્લવી', 'પાલોમા', 'પમ્મા', 'પરમિતા', 'પાયલ', 'પિયાલી', 'પ્રેરણા', 'પ્રિયા', 'પ્રિયા', 'પ્રિયંકા', 'રાધિકા', 'રીમા', 'રીમા', 'રેશ્મા', 'રિતુપર્ણા', 'રિયા', 'રોહિણી', 'રોશની', 'રોશની', 'રોશની', 'રોશની', 'રુમા', 'રૂમાલ', 'રુપસા', 'રુપસા', 'સત્યપાલ', 'રિયા'
]

gujurati_firstnames_male = [
 'અરિજિત', 'અભિષેક', 'આદિત્ય', 'અગ્નિવ', 'આલોક', 'અમિત', 'અમિતાભ', 'અનન્યા', 'અનિરુદ્ધ', 'અંકુર', 'અનિરુદ્ધ', 'અરિજિત', 'અરિંદમ', 'અરિંદમ', 'અરિન્દમ', 'અરિન્દમ', 'અરિજીત', 'અરિક', 'અરિક', 'અભીક', 'અયાન', 'વિકાસ', 'વિકાસ', 'અરિન્દમ', 'અરિક્ત', 'અરિન્દમ', 'અરિન્દમ', 'અરિન્દમ', 'અરીક', 'અરિક', 'અરિક', 'અ',
 'વિશ્વદીપ', 'ચંદન', 'દેવજ્યોતિ', 'દીપમંતી', 'દીપાંકર', 'દીપાંકર', 'દીપાંતરીન', 'દીપનીત', 'દીપનીતિ', 'દીપનીતિ', 'દીપનીતિ', 'અરિજિત', 'અરિજિત', 'અરિક', 'અરિજિત', 'અરિજિત', 'અરીક', 'આરિક', 'આરિક', 'આરીક', 'અરિજિત', 
  'જયંત', 'જીષ્ણુ', 'કુંતલ', 'મિલન', 'મિથુન', 'મનોરંજન', 'મુકુલ', 'નીલાદરી', 'પંકજ', 'પ્રસેનજિત', 'પ્રવીણ', 'પ્રીતમ', 'રાઘવ', 'રાહુલ', 'રાજા', 'રજત', 'રણજય', 'રતન', 'રિતમ', 'સબ્યસાચી', 'બીચ', 'સંદીપ', 'સંદીપ', 'પ્રદીપ',
]
...
gujurati_surnames = [
  ...
  "ਦੀਕਸ਼ਿਤ",
  "ਗੁਨਾਹਗਾਰ",
  'અકમલ', 'ચીમા', 'ચૌધરી', 'હીરા', 'જસવીર', 'ખંડોવા', 'ખુલ્લર', 'કોહલી', 'મક્કર', 'મિયાં', 'રાણા', 'રંધાવા', 'સરના', 'સેહગલ', 'સિંહ', 'સંધુ', 'તલવાર', 'ઠુકરાલ', 'વિર્ક', 'વિર્ક'
  ]
